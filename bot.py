...
# ==================== CONFIGURATION ====================
BOT_TOKEN = "8704716608:AAEwVZJFys0GJqjTe4hdWbgnHPoROgLv12s" 

# Multiple Admins Support (All 3 Admins)
ADMIN_IDS = [ 5785924075,7964523755]

# MongoDB Atlas URI
MONGO_URI = "mongodb+srv://priyal:priyal0001@priyal.mkbqhiq.mongodb.net/?appName=Priyal"
...
REGISTRATION_LINK = "https://bdgwindu.com/#/register?invitationCode=2627615796252"
# =======================================================
...
async def send_welcome_content(context: ContextTypes.DEFAULT_TYPE, user_id: int, first_name: str):
    try:
        ...
        video_keyboard = [
            [InlineKeyboardButton("📦 VIP CHANNEL", url="https://t.me/+dBSZXCItor5iOGE0")],
            [InlineKeyboardButton("🔗 REGISTRATION LINK", url="https://bdgwindu.com/#/register?invitationCode=2627615796252")]
        ]
        ...
        audio_keyboard = [
            [InlineKeyboardButton("💬 DM FOR LOSS RECOVERY", url="https://t.me/m/Qm3g_pafYzVl")]
        ]
